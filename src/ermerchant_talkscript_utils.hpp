...
OPEN_REGULAR_SHOP_STATE(5206, spirit_summons_shop_state, &browse_inventory_state,
                        ermerchant::shops::spirit_summons);
OPEN_REGULAR_SHOP_STATE(5207, consumables_shop_state, &browse_inventory_state,
                        ermerchant::shops::consumables);
OPEN_REGULAR_SHOP_STATE(5208, materials_shop_state, &browse_inventory_state,
                        ermerchant::shops::materials);
OPEN_REGULAR_SHOP_STATE(5209, miscellaneous_items_shop_state, &browse_inventory_state,
...
from::EzState::transition items_transition(nullptr, "\x57\x84\x82\x38\x00\x00\x00\x95\xa1");
